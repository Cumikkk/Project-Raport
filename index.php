          ...
          <div class="col-md-6 d-flex flex-column justify-content-center p-4">
            ...
            <form>
              <div class="input-group mb-3">
                ...
                <input type="email" class="form-control border-start-0" placeholder="Email Or Username" aria-label="Email">
              </div>
              <div class="input-group mb-3">
                <span class="input-group-text">
                ...
                <input type="password" class="form-control border-start-0" placeholder="Password" aria-label="Password">
              </div>
